...
$sql = "SELECT t.id as id, t.id as id_turma, t.turma as turma, d.id as disciplina , dep.id as departamento, COALESCE(t.id_professor,-2) as id_professor, dp.id as dp, COALESCE(t.id_sala,-2) as id_sala 
