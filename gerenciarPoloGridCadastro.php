...
?>
<form method="post" action="listaPolosGridCadastro.php">
    <fieldset>
    ...
    <button type="submit" class="btn btn-primary" onClick="validaCadastroPolo(2)"><?php if($id=="-1") echo "Cadastrar"; else echo "Salvar altera&ccedil;&otilde;s"; ?></button>  
    <button type="reset" class="btn btn-primary" onClick="validaCadastroPolo(3)">Voltar</button>	
</form>   
</div>
